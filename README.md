...
<div align="center">
  <h1><b>Hello world App</b></h1><a name="about-project"></a>
</div>
...
Simple app to test interaction within React and RoR.
...
```sh
  cd my-folder
  git clone https://github.com/enmanuelbayen/Hello-world-RoR-React.git
```
...
Feel free to check the [issues page](https://github.com/enmanuelbayen/Hello-world-RoR-React/issues).
